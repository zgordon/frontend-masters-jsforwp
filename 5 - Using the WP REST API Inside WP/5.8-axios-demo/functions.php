...
function jsforwp_enqueue_scripts() {
  ...
  if( is_page_template( 'custom.php' ) ) {
    ...
    wp_enqueue_script( 'axios-js', 'https://unpkg.com/axios/dist/axios.min.js', [], time(), true );
    wp_enqueue_script( 'jsforwp-helpers-js', get_stylesheet_directory_uri() . '/assets/js/helpers.js', [], time(), true );
    wp_enqueue_script( 'jsforwp-theme-js', get_stylesheet_directory_uri() . '/assets/js/theme.js', [ 'wp-api', 'jsforwp-helpers-js', 'axios-js' ], time(), true );
