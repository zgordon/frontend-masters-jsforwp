<?php
/*
   Plugin Name: 2.3 - Enqueuing Plugin Page JavaScript (Completed)
   Version: 1.0.0
   Author: Zac Gordon
   Author URI: https://twitter.com/zgordon
   Description: Example of how to load JavaScript only on the plugin admin page
...
$main_menu_url = 'jsforwp-2-3-completed';
