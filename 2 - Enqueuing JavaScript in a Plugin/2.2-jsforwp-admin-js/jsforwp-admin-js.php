<?php
/*
   Plugin Name: 2.2 - Enqueuing Admin Area JavaScript
   Version: 1.0.0
   Author: Zac Gordon
   Author URI: https://twitter.com/zgordon
   Description: Learn how to load JavaScript on a backend plugin page (and frontend) of a WordPress site using a plugin
   Text Domain: jsforwp-admin-js
   License: GPLv3
*/
