...
(function () {
  ...
  var reader = direct.create({
    sources: [
      ...
      source("bolt", "tinymce.core.ui.Container", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.ui.Factory", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.ui.Form", ".", mapper.constant("plugin")),
      ...
      source("bolt", "tinymce.core.ui.Control", ".", mapper.constant("plugin")),
      source("bolt", "tinymce.core.ui.DragHelper", ".", mapper.constant("plugin")),
