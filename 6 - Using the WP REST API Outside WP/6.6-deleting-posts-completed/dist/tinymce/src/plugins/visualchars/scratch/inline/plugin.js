...
defineGlobal("8", Array);
defineGlobal("9", Error);
define(
  "b",
...
define("c", [], function () { if (typeof console === "undefined") console = { log: function () {} }; return console; });
