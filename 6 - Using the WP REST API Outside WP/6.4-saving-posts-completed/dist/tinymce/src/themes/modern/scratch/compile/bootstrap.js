...
(function () {
  ...
  var reader = direct.create({
    sources: [
      ...
      source("bolt", "tinymce.core.AddOnManager", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.EditorManager", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.Env", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.ui.Api", ".", mapper.constant("theme")),
      ...
      source("bolt", "tinymce.core.ui.FloatPanel", ".", mapper.constant("theme")),
      source("bolt", "tinymce.core.ui.Throbber", ".", mapper.constant("theme")),
